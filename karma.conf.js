// Karma configuration
// Generated on Mon Mar 07 2016 15:03:27 GMT+0000 (GMT)

var configuration = require("./plugin/config");
...
module.exports = function(config) {
  config.set({
    ...
    browserify: {
      debug: false,
      transform: configuration.get("transforms"),
      extensions: configuration.get("ext"),
      bundleDelay: 1000
    },
